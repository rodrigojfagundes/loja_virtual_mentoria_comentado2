...
//classe q vai tera var/obj para criar uma cobranca na api da
//asaas
public class CobrancaApiAsaas {
	...
	//instanciando um obj/var do tipo DISCONTCOBRANCAASAAS
	//q basicamente vai ter atributor/var para o valor NORMAL
	//e o valor com desconto
	private DiscontCobancaAsaas discount = new DiscontCobancaAsaas();
	
	//acho q e porcentagem
	private FineConbrancaAsaas fine = new FineConbrancaAsaas();
	
	//class para taxa de juros
