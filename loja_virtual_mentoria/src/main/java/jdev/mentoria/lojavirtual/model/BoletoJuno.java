...
//classe/entidade q tera os atributos relacionados a um boleto
//tipo data, valor, empresa, etc... Basicamente essa class/entity
//serve para criar uma tabela para armazenar os boletos...
@Entity
...
public class BoletoJuno implements Serializable {
	...
	//Código de controle do boleto (nao e o codigo de barra)
	private String code = "";
