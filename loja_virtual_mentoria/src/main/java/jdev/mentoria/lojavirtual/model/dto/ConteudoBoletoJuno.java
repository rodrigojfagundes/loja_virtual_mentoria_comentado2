...
//
//baiscamente sera instanciada no EMBEDDED.JAVA e vai servir
//para armazenarmos nos atributos/var os dados retornados pela
//API da JUNO apos nos enviarmos os dados q estao 
//instanciados no COBRANCAJUNOAPI.java, para gerar um boleto/pix para API
//da JUNO... Algumas coisas do retorno da API da JUNO com o boleto
//gerado sera salvo aqui...
//
public class ConteudoBoletoJuno implements Serializable {
	...
	//ACHO Q o PAYNUMBER e o numero de codigo de barra do boleto...
