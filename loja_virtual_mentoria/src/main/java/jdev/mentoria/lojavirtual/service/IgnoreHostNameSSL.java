...
//essa classe trabalha em consulto com HOSTIGNORINGCLIENT
public class IgnoreHostNameSSL implements HostnameVerifier, Serializable {
	...
	//list de certificado(foi o q o prof disse)
	...
	//em resumo se tiver um hostname ele vai dar um true para dizer q
	//tem certificado, mesmo nao tendo...
	@Override
