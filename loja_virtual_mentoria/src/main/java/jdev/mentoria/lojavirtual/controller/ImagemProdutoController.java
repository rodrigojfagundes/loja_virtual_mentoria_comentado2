...
public class ImagemProdutoController {
	...
	public ResponseEntity<ImagemProdutoDTO> salvarImagemProduto(
		...
		return new ResponseEntity<ImagemProdutoDTO>(
				imagemProdutoDTO, (HttpStatus.OK));
	}
	...
	public ResponseEntity<?> deleteImagemObjeto(@RequestBody ImagemProduto imagemProduto) {
		...
		if (!imagemProdutoRepository.existsById(imagemProduto.getId())) {
			return new ResponseEntity<String>("Imagem ja foi removida ou nao existe com esse id: " + imagemProduto.getId(), HttpStatus.OK);
		}
	...
	public ResponseEntity<?> deleteImagemProdutoPorID(@PathVariable("id") Long id) {
		...
		if (!imagemProdutoRepository.existsById(id)) {
			return new ResponseEntity<String>("Imagem ja foi removida ou nao existe com esse id: " + id, HttpStatus.OK);
		}
	...
	public ResponseEntity<List<ImagemProdutoDTO>> obterImagemPorProduto(
			@PathVariable("idProduto") Long idProduto){
		
		List<ImagemProdutoDTO> dtos = new ArrayList<ImagemProdutoDTO>();
		
		
		List<ImagemProduto> imagemProdutos = imagemProdutoRepository.
				buscaImagemProduto(idProduto);
		...
		return new ResponseEntity<
				List<ImagemProdutoDTO>>(dtos, HttpStatus.OK);
